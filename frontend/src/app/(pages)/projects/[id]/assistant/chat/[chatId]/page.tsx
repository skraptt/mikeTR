...
export default function ProjectAssistantChatPage({ params }: Props) {
    ...
    const username =
        profile?.displayName?.trim() || user?.email?.split("@")[0] || "burada";
                ...
                <div className="flex items-center gap-1.5 text-2xl font-medium font-serif">
                    ...
                    {chatLoaded ? (
                        <span className="text-gray-900 truncate max-w-xs">
                            {chatTitle ?? "Başlıksız yeni sohbet"}
                        </span>
                    ) : (
                            ...
                            <div className="flex items-center justify-center h-full px-8 bg-gray-100">
                                <div className="text-center space-y-3">
                                    <p className="font-serif text-gray-700 text-xl">
                                        Burada görüntülemek için bir belgeye tıklayın.
                                    </p>
                                    <p className="font-serif text-base text-gray-500">
                                        İpucu: Okuması veya düzenlemesi için bir
                                        belgeyi Proje Gezgini&apos;nden Asistan&apos;a
                                        sürükleyin.
                                    </p>
                                </div>
                            </div>
