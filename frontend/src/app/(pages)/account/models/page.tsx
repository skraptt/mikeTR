        ...
        <div className="space-y-4">
            ...
            <div className="py-6">
                ...
                <p className="text-sm text-gray-500 mb-4 max-w-xl">
                    Uygulamanın çalışması için kendi API anahtarlarınızı sağlamalı veya Mike'ın kendi örneğini çalıştırıyorsanız API anahtarlarınızı .env dosyasına eklemelisiniz.
                </p>
                <p className="text-xs text-gray-400 mb-4 max-w-xl">
                    Başlık oluşturması, yapılandırdığınız sağlayıcının en ucuz modeline otomatik olarak yönlendirilir (Gemini anahtarı ayarlanmışsa Gemini Flash Lite, aksi takdirde Claude Haiku).
                </p>
