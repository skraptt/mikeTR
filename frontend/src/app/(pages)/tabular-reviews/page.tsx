...
const TABS: { id: Tab; label: string }[] = [
    { id: "all", label: "Tüm İncelemeler" },
    { id: "in-project", label: "Projedeki" },
...
export default function TabularReviewsPage() {
    ...
    async function handleRenameSubmit(reviewId: string) {
        ...
        if (review && user?.id && review.user_id !== user.id) {
            setRenamingId(null);
            setOwnerOnlyAction("bu tablo incelemesini yeniden adlandır");
            return;
        }
        setReviews((prev) =>
    ...
    async function handleDeleteSelected() {
        ...
        if (blocked > 0) {
            setOwnerOnlyAction(
                `Seçilen incelemelerden ${blocked} tanesi silinemedi — bir incelemeyi yalnızca oluşturan kişi silebilir`,
            );
        }
    }
    ...
    return (
        <div className="flex-1 overflow-y-auto bg-white">
            ...
            <div className="flex items-center justify-between px-8 py-4">
                ...
                <div className="flex items-center gap-2">
                    <HeaderSearchBtn value={search} onChange={setSearch} placeholder="İncelemelerde ara…" />
                    <button
            ...
            <div className="w-full overflow-x-auto">
                ...
                <div className="flex items-center h-8 pr-8 border-b border-gray-200 text-xs text-gray-500 font-medium select-none">
                    ...
                    <div className="w-24 shrink-0">Belgeler</div>
                        ...
                        {activeTab === "all" && !projectFilter ? (
                            <>
                                ...
                                <p className="mt-1 text-xs text-gray-400 max-w-xs text-left">
                                    Yapay zeka kullanarak belgelerden tabloya
                                    veri çıkarın.
                                </p>
                                <button
                                    onClick={() => setNewTROpen(true)}
                                        ...
                                        <RowActions
                                            onRename={() => {
                                                if (
                                                    ...
                                                    setOwnerOnlyAction(
                                                        "bu tablo incelemesini yeniden adlandır",
                                                    );
                                                    return;
                                                }
                                                setRenameValue(
