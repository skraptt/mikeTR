                ...
                >
                        ...
                        {columns.map((column, index) => (
                            ...
                            >
                                ...
                                {column.format === "tag" && (
                                    <div className="mt-3">
                                        ...
                                        <p className="mt-1 text-xs text-gray-400">
                                            Etiket eklemek için Enter veya virgül tuşuna basın.
                                        </p>
                                    </div>
                                )}
                                ...
                                <textarea
                                    ...
                                    placeholder="Analiz istemini yazın — Mike'ın bu sütun için her belgeden ne çıkarması gerektiğini açıklayın…"
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100 px-6 py-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                {isEditing ? "Değişiklikleri kaydet" : "Sütunları ekle"}
                            </button>
                        </div>
                    </div>
                </form>
