...
export function AddDocumentsModal({
    ...
    async function handleDelete(ids: string[]) {
        ...
        if (owned.length === 0 && blocked > 0) {
            setOwnerOnlyAction(
                "bu belgeleri sil — yalnızca belgeyi oluşturan kişi bir belgeyi silebilir",
            );
            return;
        }
        ...
        if (blocked > 0) {
            setOwnerOnlyAction(
                `seçili belgelerden ${blocked} tanesini sil — yalnızca belgeyi oluşturan kişi bir belgeyi silebilir`,
            );
        }
    }
            ...
            <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl flex flex-col h-[600px]">
                ...
                <div className="flex-1 overflow-y-auto px-4 pb-2">
                    <FileDirectory
                        ...
                        forceExpanded={!!q}
                        emptyMessage={
                            q ? "Eşleşme bulunamadı" : "Henüz belge yok"
                        }
