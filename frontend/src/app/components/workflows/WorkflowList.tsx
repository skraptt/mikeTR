...
export function WorkflowList() {
    ...
    const practiceFilterButton = (
        <div className="relative" ref={practiceFilterRef}>
            ...
            >
                {practiceFilter ?? "Alana göre filtrele"}
                <ChevronDown className="h-3 w-3" />
            </button>
            {practiceFilterOpen && (
    ...
    return (
        <div className="flex flex-col flex-1 overflow-hidden bg-white">
            ...
            <div className="flex items-center justify-between px-8 py-4 shrink-0">
                <h1 className="text-2xl font-medium font-serif text-gray-900">İş Akışları</h1>
                <div className="flex items-center gap-2">
                    <HeaderSearchBtn
                        value={search}
                        onChange={setSearch}
            ...
            <div className="flex-1 overflow-auto">
                <div className="min-w-max">
                    ...
                    <div className="flex items-center h-8 pr-8 border-b border-gray-200 text-xs text-gray-500 font-medium select-none">
                        ...
                        <div className="w-40 shrink-0">Alan</div>
                            ...
                            {activeTab === "custom" ? (
                                <>
                                    ...
                                    <p className="mt-1 text-xs text-gray-400 text-left">
                                        Alanınıza uygun yeniden kullanılabilir
                                        istemler ve tablo inceleme şablonları
                                        oluşturun.
                                    </p>
                                    <button
                                        onClick={() => setNewModalOpen(true)}
                                ...
                                <>
                                    ...
                                    <p className="mt-1 text-xs text-gray-400 text-left">
                                        Gizlediğiniz yerleşik iş akışları burada
                                        görünür. İstediğiniz zaman yeniden
                                        gösterebilirsiniz.
                                    </p>
                                </>
                            ) : (
                                <>
                                    ...
                                    <p className="mt-1 text-xs text-gray-400 text-left">
                                        Yeniden kullanılabilir istemler ve tablo
                                        inceleme şablonlarıyla belge analizini
                                        otomatikleştirin.
                                    </p>
                                </>
                            )}
