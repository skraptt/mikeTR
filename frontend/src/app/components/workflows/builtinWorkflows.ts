...
export const BUILT_IN_WORKFLOWS: MikeWorkflow[] = [
    ...
    // ─── Commercial Agreement ───────────────────────────────────────────────────
    {
        ...
        columns_config: [
            ...
            },
            {
                ...
                name: "İş Kapsamı",
                format: "text",
                prompt: "What goods or services are covered by this agreement? Summarise the scope of supply or services and any exclusions.",
            },
            {
                index: 2,
                name: "Önceki Sözleşmeyi Değiştiriyor",
                format: "text",
            ...
            },
            {
                ...
                format: "date",
                prompt: "What is the effective date or commencement date of this agreement? If no explicit date is stated, note when it takes effect.",
            },
            {
                index: 4,
                name: "Süre",
    ...
    // ─── SPA ─────────────────────────────────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Hisse Satın Alma Sözleşmesi İncelemesi",
        type: "tabular",
        practice: "Kurumsal",
        prompt_md: null,
        columns_config: [
            ...
            {
                index: 11,
                name: "Uygulanacak Hukuk ve Yargı Yetkisi",
                format: "text",
    ...
    // ─── NDA ─────────────────────────────────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Gizlilik Sözleşmesi İncelemesi",
        type: "tabular",
        practice: "Genel İşlemler",
        prompt_md: null,
        columns_config: [
    ...
    // ─── Commercial Lease ─────────────────────────────────────────────────────────
    {
        ...
        columns_config: [
            ...
            {
                index: 18,
                name: "Hükmen Fesih ve Sona Erme",
                format: "text",
    ...
    // ─── Limited Partnership Agreement ───────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Sınırlı Ortaklık Sözleşmesi İncelemesi",
        type: "tabular",
        ...
        columns_config: [
            ...
            {
                index: 3,
                name: "Sermaye Çağrıları ve Çekişler",
                format: "text",
            ...
            {
                index: 4,
                name: "Fonlamama Halinde Cezalar",
                format: "text",
            ...
            {
                index: 9,
                name: "Tercihli Getiri (Eşik Getiri)",
                format: "percentage",
    ...
    // ─── Shareholder Agreement ────────────────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Hissedar Sözleşmesi İncelemesi",
        type: "tabular",
        practice: "Kurumsal",
        prompt_md: null,
        columns_config: [
            ...
            {
                index: 5,
                name: "Özel Onay Gerektiren Konular",
                format: "bulleted_list",
            ...
            {
                index: 8,
                name: "Önalım Hakkı / Devirde Ön Alım",
                format: "text",
            ...
            {
                index: 15,
                name: "Rekabet Etmeme ve Müşteri/Kişi Ayartmama",
                format: "text",
    ...
    // ─── Employment Agreement ─────────────────────────────────────────────────────
    {
        ...
        columns_config: [
            ...
            },
            {
                ...
                prompt: "Bu pozisyon tam zamanlı mı yarı zamanlı mı? Yarı zamanlıysa, belirtilmişse haftalık gün veya saat sayısını belirtin.",
            },
            {
                index: 6,
            ...
            {
                index: 8,
                name: "Bildirim Süresi (İşverenden Çalışana)",
                format: "text",
            ...
            {
                index: 9,
                name: "Bildirim Süresi (Çalışandan İşverene)",
                format: "text",
